   ...
   <div class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title mb-3">Nuevo Alumno</div>
                            @if (count($errors) > 0)
                            ...
                            @endif
                        <form id="form_student" class="needs-validation" novalidate method="POST" onsubmit="return false;" action="{{ url('/student') }}">
                            {{ csrf_field() }}
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="number" class="form-control form-control-rounded" 
                                            name="matricula" id="matricula" placeholder="Matricula" value="{{ $last_m->matricula+1 }}" disabled>
                                    </div>
                                    
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="birth_date">Fecha de nacimiento</label>
                                        <input type="date" class="form-control form-control-rounded" 
                                            name="birth_date" id="birth_date" placeholder="Fecha de nacimiento">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                         <button id="submit_form" class="btn btn-success" type="submit">Crear Alumno</button>
